        ...
        content=ft.Container(
            content=ft.Column([
                ft.Row([
                    ...
                    ft.Text("Финансовая аналитика (30 дн.)", size=16, weight=ft.FontWeight.BOLD, expand=True)
                ...
                ft.Divider(height=1, color=ft.Colors.BLACK_12),
                ft.Row([
                    ft.Text(" Стоимость 1 км пути:", size=13, weight=ft.FontWeight.W_500, expand=True),
                    ft.Container(
        ...
        content=ft.Container(
            content=ft.Column([
                ft.Row([
                    ...
                    ft.Text("Эффективность и окупаемость ГБО", size=14, weight=ft.FontWeight.BOLD, expand=True)
                ]),
                ft.Divider(height=1, color=ft.Colors.BLACK_12),
                ft.Row([
                    ft.Text(" Реальный расход на Газ:", size=13, expand=True),
                ...
                ft.Column([
                    ft.Row([
                        ft.Text("Прогресс окупаемости оборудования:", size=11, color=ft.Colors.GREY_600, expand=True),
    ...
    def save(_):
        try:
            ...
            p_profile["history"].append({
                ...
                "comment": f"Деталь: {h_part_name.value.strip()} [Арт: {h_part_code.value.strip()}]" if h_part_code.value.strip() else ""
            })
...
def show_delete_car_dialog(page, current_db, selected_car, refresh_callback):
    ...
    def confirm_delete(_):
        current_db["cars"].pop(selected_car); engine.save_data(current_db); engine.app_state["selected_car"] = list(current_db["cars"].keys()); dialog.open = False; refresh_callback()
