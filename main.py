    ...
    def rebuild_ui():
        ...
        def add_car_click(e):
            ...
            def save_new_car(_):
                ...
                if not name or name in current_db["cars"]: 
                    return
                ...
                ft.Row(
                    ...
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            on_click=lambda _: [network.auto_import_last_file(page, show_message)] if os.name != "nt" else [run_local_telegram_sync(), page.data.update({"db_data": engine.load_data()}), refresh_ui(), show_message("✅ База данных успешно импортирована локально из Telegram Desktop!")]
                        ),
